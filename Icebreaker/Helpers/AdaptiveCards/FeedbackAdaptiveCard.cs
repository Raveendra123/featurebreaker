...
namespace Icebreaker.Helpers.AdaptiveCards
{
    ...
    public static class FeedbackAdaptiveCard
    {
        ...
        public static string GetCard(string firstPersonName, string firstPersonFirstName, string personUpn1, string personUpn2, string feedbackId)
        {
            ...
            var feedbackCardMatchedText = string.Format(Resources.MatchUpCardMatchedText, firstPersonName);
            var feedbackCardContentPart = Resources.FeedbackCardContentPart;
            var chatWithMatchButtonText = string.Format(Resources.ChatWithMatchButtonText, firstPersonFirstName);
            var feedbackButtonText = Resources.FeedbackButtonText;
            var feedbackUploadImageButtonText = Resources.FeedbackUploadImageButtonText;
            ...
            var variablesToValues = new Dictionary<string, string>()
            {
                ...
                { "feedbackCardMatchedText", feedbackCardMatchedText },
                { "feedbackCardContentPart", feedbackCardContentPart },
                { "chatWithMatchButtonText", chatWithMatchButtonText },
                { "feedbackButtonText", feedbackButtonText },
                { "feedbackUploadImageButtonText", feedbackUploadImageButtonText },
